  ...
  const posts: PostWithTags[] = [
    {
      ...
      commentTexts: ["The Burlington case study is incredibly relevant to our situation.", "Aspen's community buy-in approach is worth studying closely.", "Has anyone started the grid integration peer review?", "Can we add the Copenhagen district heating model?", "The 2030 framework should reference EU renewable directives."]
    },
    {
      id: "kb-2",
      type: "collection",
      ...
      commentTexts: ["The impact metrics need to be normalised per capita.", "Great executive summary — very clear for non-technical stakeholders.", "Can we add a section on water usage impacts?"]
    },
    {
      id: "kb-3",
      type: "text",
      ...
      commentTexts: ["The facilitation techniques section is excellent.", "We should add a section on handling dissenting voices constructively.", "Can we translate these guidelines into Spanish for our bilingual communities?", "The post-workshop follow-up templates saved us so much time."]
    },
    {
      id: "kb-4",
      type: "collection",
      ...
      commentTexts: ["The vendor comparison is missing SolarEdge — can we add them?", "Smart meter specs need updating for the new firmware version.", "Regulatory compliance checklist is very thorough."]
    },
    {
      id: "kb-5",
      type: "text",
      ...
      commentTexts: ["The DOE Community Power Accelerator deadline is approaching fast.", "Has anyone applied for the state-level green infrastructure grant?", "Eligibility criteria seem to favour municipalities with existing solar."]
    },
    {
      id: "kb-6",
      type: "collection",
      ...
      commentTexts: ["Action items from last meeting are mostly complete.", "We need to follow up with the transport department on EV charging.", "Stakeholder contact list should include the new council members."]
    },
    {
      id: "kb-7",
      type: "text",
      ...
      commentTexts: ["Demand-response programs could save 15% on peak usage.", "The seasonal variation data matches our utility reports.", "Can we overlay weather data for correlation analysis?"]
    },
    {
      id: "kb-8",
      type: "collection",
      ...
      commentTexts: ["Brand voice guidelines are well written.", "We need a template for newsletter announcements too.", "Social media playbook should include TikTok strategy."]
    },
    {
      id: "kb-9",
      type: "text",
      ...
      commentTexts: ["The permitting process section is very helpful.", "Zoning considerations differ by district — should we add a map?", "Environmental impact assessment could take 6+ months."]
    },
    {
      id: "kb-10",
      type: "collection",
      ...
      commentTexts: ["The degradation curves are really useful for long-term planning.", "Total cost of ownership should include inverter replacement costs.", "SunPower panels have the best efficiency but highest cost.", "Can we get samples for field testing?"]
    },
    {
      id: "kb-11",
      type: "text",
      ...
      commentTexts: ["The ROI timeline for scenario B looks most realistic.", "Risk-adjusted models should account for energy price volatility.", "Can we present these projections to the finance committee?"]
    },
    {
      id: "kb-12",
      type: "collection",
      ...
      commentTexts: ["The homeowner's guide is fantastic — very accessible language.", "Can we distribute the infographic at community events?", "Energy efficiency checklist should include heat pump recommendations.", "The Q&A recordings are a great resource for newcomers.", "We should create a version for renters too."]
    },
    {
      id: "kb-13",
      type: "text",
      ...
      commentTexts: ["200 stations by 2028 is ambitious but achievable.", "Grid capacity in the downtown area is a bottleneck.", "Site selection should prioritise equity-focused neighbourhoods.", "The phased rollout makes sense — start with municipal parking lots.", "We need to coordinate with the utility on transformer upgrades."]
    },
    {
      id: "kb-14",
      type: "text",
      ...
      commentTexts: ["The aggressive scenario reduces emissions by 80% — impressive.", "Sensitivity analysis shows we're highly dependent on federal subsidies.", "Key assumptions around natural gas prices may be too optimistic."]
    },
    {
      id: "kb-15",
      type: "collection",
      ...
      commentTexts: ["The RACI matrix template is very clean and easy to use.", "Decision log should be updated after each steering committee."]
    },
    {
      id: "kb-16",
      type: "text",
      ...
      commentTexts: ["PPA terms should include escalation caps.", "Community solar subscriptions are gaining popularity.", "We need legal review on the municipal investment pathway."]
    },
    {
      id: "kb-17",
      type: "collection",
      ...
      commentTexts: ["Building 12 has the highest savings potential — 40% reduction possible.", "The retrofit priority list should factor in building age.", "Payback periods under 5 years should be fast-tracked.", "Can we get contractor quotes for the top 10 buildings?"]
    },
    {
      id: "kb-18",
      type: "text",
      ...
      commentTexts: ["The STEM activities are age-appropriate and engaging.", "Mentorship connections with local engineers would be amazing.", "Green careers pathway section is very inspiring for students.", "Can we partner with the university for guest lectures?"]
    },
    {
      id: "kb-19",
      type: "text",
      ...
      commentTexts: ["The environmental justice analysis is well-researched.", "Budget justification needs to reflect updated cost estimates.", "Letters of support from community groups strengthened the application."]
    },
    {
      id: "kb-20",
      type: "collection",
      ...
      commentTexts: ["Flood risk mapping should be updated with 2025 data.", "Heat island mitigation through urban forestry is cost-effective.", "Emergency preparedness section needs input from fire department.", "The adaptation action plan should integrate with the county plan."]
    },
  ];
